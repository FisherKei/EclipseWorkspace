...
public class DateTimePicker extends DialogFragment {
	...
	private View createDateTimeView(LayoutInflater layoutInflater) {
		...
		View mView = layoutInflater.inflate(R.layout.custom_datetimepicker, null);
		// Extract the TabHost
		...
		mDateTab.setIndicator(getString(R.string.strTabDate));
		...
		mTimeTab.setIndicator(getString(R.string.strTabTime));
